...
// Date created:         Fri Oct 18 10:59:41 CEST 2019
...
xlr {
  template('4.5 Proporcionar mecanismos de marcha atrás de manera coordinada y unitaria.') {
    ...
    scriptUserPassword '{aes:v0}pYX5nfCYpkZck5OR0CL72yLGvRj/xXwbUqYjqSofrWE='
    phases {
      phase('SELECCIÓN VERSIONES') {
        color '#0099CC'
        tasks {
          userInput('Selección de versiones CSS implicadas en el despliegue') {
          ...
          userInput('Selección de versiones JAVASCRIPT implicadas en el despliegue') {
          ...
          userInput('Selección de versiones JAVA implicadas en el despliegue') {
            description 'Please enter the required information below.'
            owner 'admin'
            variables {
              variable 'java'
